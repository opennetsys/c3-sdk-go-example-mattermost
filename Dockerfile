...
RUN mkdir -p /go /go/bin /go/src /go/src/github.com/c3systems/mattermost-server /go/pkg
...
WORKDIR /go/src/github.com/c3systems/mattermost-server

# Copy the local package files to the container's workspace.
COPY . /go/src/github.com/c3systems/mattermost-server

RUN ["chmod", "+x", "/go/src/github.com/c3systems/mattermost-server/docker-entrypoint.sh"]
RUN ["chmod", "+x", "/go/src/github.com/c3systems/mattermost-server/wait.sh"]
ENTRYPOINT ["/go/src/github.com/c3systems/mattermost-server/docker-entrypoint.sh"]
