...
Inline Image with link, alt text, and hover text: ![Build Status](https://travis-ci.org/c3systems/c3-sdk-go-example-mattermost.svg?branch=master)](https://travis-ci.org/c3systems/c3-sdk-go-example-mattermost)
